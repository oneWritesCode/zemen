...
const steps = [
  {
    ...
    icon: <Database className="h-8 w-8 text-[#FFD000]" />,
  ...
  },
  {
    ...
    icon: <Cpu className="h-8 w-8 text-[#FFD000]" />,
  ...
  },
  {
    ...
    icon: <Target className="h-8 w-8 text-[#FFD000]" />,
  ...
  },
  {
    ...
    icon: <History className="h-8 w-8 text-[#FFD000]" />,
    ...
    <PresentationShell>
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        <p className="section-reveal mt-6 max-w-3xl text-xl text-zinc-400 leading-relaxed">
          Zemen turns noisy economic data into <span className="text-[#FFD000] font-semibold">one simple answer</span> by following a four-step automated process.
        </p>
          ...
          {steps.map((step) => (
            <section key={step.title} className="section-reveal group relative">
              ...
              <div className="flex flex-col lg:flex-row gap-12 items-start">
                <div className="shrink-0 p-5 rounded-3xl bg-[#FFD000]/10 border border-[#FFD000]/20 group-hover:bg-[#FFD000]/20 transition-all duration-500">
                  {step.icon}
                </div>
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-zinc-100 group-hover:text-[#FFD000] transition-colors">{step.title}</h2>
                  ...
                  <div className="mt-10 grid gap-4 overflow-hidden sm:grid-cols-5">
                    {step.visual.map((block, index) => (
                      <div
                        ...
                        className="relative rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-6 text-center transition-all hover:bg-white/[0.06] hover:border-[#FFD000]/30"
                      >
                        <div className="mb-3 flex justify-center">
                          <CheckCircle2 className="h-4 w-4 text-[#FFD000]/40" />
                        </div>
