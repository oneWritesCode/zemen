  ...
  return (
    <div className="min-h-screen bg-[#080808] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[#FFD000]/5 blur-[120px]" />
        ...
        <div className="bg-[#0d0d0d] border border-white/[0.05] rounded-3xl p-8 shadow-2xl">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-[#666]">Access your macro intelligence</p>
            </div>
          </div>
          ...
          <p className="mt-8 text-center text-xs text-[#444]">
            ...
            <Link href="/register" className="text-white hover:text-[#FFD000] transition-colors font-bold">
              Register here
            </Link>
          </p>
        </div>
